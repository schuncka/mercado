             ...
             <td width="3px" align="center">
                    <div class="button-dropdown place-left" style="width:20px; height:20px; border:0px solid #F00;">
                            ...
                            <ul class="dropdown-menu" data-role="dropdown">
                                <li><%=AthWindowNew ("detail.asp?var_cod_pal_evento=" & GetValue(objRS,"COD_PALESTRANTE_EVENTO") & "&var_nome_evento=" & GetValue(objRS,"NOME"), 520, 720,ucase(objLang.SearchIndex("mini_visualizar",0))  )%></li>                                
                            </ul>
                    </div>
             </td>
        <!--Menu Action FIM-----------------------------------------------------------------------------------------------------//-->
