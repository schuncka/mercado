...
<div class="arial12">
  ...
  <p><strong>Passo 1</strong> &ndash;          Verifique se a Planilha Excel a ser importada segue o modelo          espec&iacute;fico para importa&ccedil;&atilde;o (<a href="MODELO_IMPORTACAO_SATOR.xls" class="arial12Bold"><u>clique aqui para baixar o modelo</u></a>).</p>
<p>a)&nbsp;&nbsp;&nbsp;&nbsp; Nome da Planilha (aba &ndash; inferior da          p&aacute;gina) deve permanecer Plan1;<br>
  ...
  c)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; A primeira linha sempre deve          constar o nome espec&iacute;fico dos dados de cada coluna &ndash;  NOME,          CPF, CATEGORIA;<br>
...
<br />
<div align="center">
<a onClick="javascript:importar();" href="#"><img src="../img/ico_excel.gif" alt="Importar Situação Cadastral - Excel"  border="0"></a><br>
<br>
<form name="formimport" action="sator_importexcel.asp" method="post" target="_blank">
            <select name="var_cod_evento" class="textbox380" onChange="document.location='sator_socios.asp?cod_evento='+this.value;">
            <%
			...
			<input type="hidden" name="var_campos" value="cod_evento - <%=strCOD_EVENTO%>, id_num_doc1, nome, cod_status_preco">
            <input type="hidden" name="var_nomes" value="<%=Server.HTMLEncode("Codigo Evento,CPF,Nome,Categoria")%>">
			<input type="hidden" name="var_label" value="<%=Server.HTMLEncode("Importar Status Cadastral")%>">
