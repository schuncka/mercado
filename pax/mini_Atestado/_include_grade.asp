                    ...
                    <div class="button-dropdown place-left" style="width:20px; height:20px; border:0px solid #F00;">
                           <img class="dropdown-toggle" src="../../img/icon_action.gif"  >                            
                             <ul class="dropdown-menu" data-role="dropdown">
                                ...
                                <li><%=AthWindowNew ("atestadopdf.asp?var_codbarra=" & GetValue(objRS,"CODBARRA") & "&var_cod_evento="&GetValue(objRS,"COD_EVENTO")& "&var_cod_empresa=" & strCOD_EMPRESA, 520, 620, ucase(objLang.SearchIndex("mini_imprimir",0)) )%></li>                                
                                <!-- li>
                                	<a href="#" style="cursor:pointer;" 
                                       onClick="certificado(<%'=GetValue(objRS,"CODBARRA")%>,<%'=GetValue(objRS,"COD_EVENTO")%>); return false;">IMPRIMIR
                                    </a>
                                </li //-->
                            </ul>
                    </div>                        
          ...
          <% 
            for j=0 to objRS.Fields.count-1 
              if inStr(strFields, objRS.Fields(j).name)>0 then
                ...
                if (objRS.Fields(j).name = "COD_EMPRESA") Then
