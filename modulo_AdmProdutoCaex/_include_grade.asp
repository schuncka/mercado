                    ...
                    <div class="button-dropdown place-left" style="width:20px; height:20px; border:0px solid #F00;">
                           <img class="dropdown-toggle" src="../img/icon_action.gif"  >                            
                            ...
                            <!--DELETE comentado pois neste modo procede que não haja exclusões de registros sem a devida supervisão//-->
								...
								<%'Direito de copiar(duplicar) o produto
                           '     if  VerificaDireito ("|COPY|", BuscaDireitosFromDB("modulo_AdmProduto",Session("METRO_USER_ID_USER")), false) = true then
                                %>
                               <li><%=AthWindow ("duplica.asp?var_chavereg=" & GetValue(objRS,DKN)&"&var_titulo="&GetValue(objRS,"TITULO"), 520, 620, "DUPLICAR")%></li>
								<%
                            '    end if
                                %>
                                <li class="divider">
                                <%'Direito de deletar( o produto
                             '   if  VerificaDireito ("|DEL|", BuscaDireitosFromDB("modulo_AdmProduto",Session("METRO_USER_ID_USER")), false) = true then
                                %>
