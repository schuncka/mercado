...
<% VerificaDireito "|UPD|", BuscaDireitosFromDB("modulo_EntradaCred",Session("ID_USER")), true %>
<%
...
function ok() {
	 <% if (CFG_WINDOW = "NORMAL") then 
  		response.write ("document.formupdate.DEFAULT_LOCATION.value='../modulo_EntradaCred/default.asp';") 
	 else
...
function aplicar()      { 
  document.formupdate.DEFAULT_LOCATION.value="../modulo_EntradaCred/update.asp?var_chavereg=<%=strCODLOCALCREDENCIAL%>"; 
  if (validateRequestedFields("formupdate")) { 
