...
<% VerificaDireito "|VIEW|", BuscaDireitosFromDB("mini_ListaCategoria",Session("METRO_USER_ID_USER")), true %>
<%
 Const MDL = "DEFAULT"          								' - Default do Modulo...
 Const LTB = "tbl_STATUS_PRECO" 								' - Nome da Tabela...
 Const DKN = "COD_STATUS_PRECO"									' - Campo chave...
 Const DLD = "../modulo_Evento/mini_ListaCategoria/default.asp" 	' "../evento/data.asp" - 'Default Location após Deleção
...
' ---------------------------------------------------------------------------------------------------------------
 ...
 strSQL = " SELECT EI.COD_STATUS_PRECO "
 strSQL = strSQL & "		  , EI.COD_EVENTO "
 strSQL = strSQL & "		  , EI.STATUS "
 strSQL = strSQL & "		  , EI.OBSERVACAO "
 strSQL = strSQL & "		  , EI.SENHA "
 strSQL = strSQL & "		  , EI.LOJA_SHOW "
 ...
 strFields = "EI.COD_STATUS_PRECO,EI.COD_EVENTO,EI.STATUS,EI.OBSERVACAO,EI.SENHA,EI.LOJA_SHOW" 
 arrFields = Split(strFields,",")        

 arrLabels = Array("COD"              ,"EVENTO"              ,"CATEGORIA"           ,  "OBS" 	          ,  "SENHA" 	,  "LOJA SHOW" )
 arrSort   = Array("sortable-numeric" ,"sortable-numeric" ,"sortable-numeric" , "sortable-numeric","sortable"   , "sortable" ) 'Obs.:"sortable-date-dmy", "sortable-currency", "sortable-numeric", "sortable" 
 arrWidth  = Array("2%"               ,"12%"               ,     "10%"  	  ,   "26%"           ,    "18%"    ,"26%"  	)     'Obs.:[somar 98%] ou deixar todos vazios
' ----------------------------------------------------------------------------------------------------------------------------
