...
<%
 ...
 Const DLD = "../modulo_Evento/mini_CfgLinks/default.asp" 	' "../evento/data.asp" - 'Default Location após Deleção
 Const TIT = "CFG Link"									' - Nome/Titulo sendo referencia como titulo do módulo no botão de filtro
