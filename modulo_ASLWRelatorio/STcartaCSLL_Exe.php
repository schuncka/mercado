...
<table align="center" bgcolor="#FFFFFF" width="98%" border="0">
  ...
  <?php
					...
					$strSQL = " SELECT DISTINCT 
											tmp_csll_carta.erazao
											, tmp_csll_carta.erodape
											, tmp_csll_carta.razaonf
											, tmp_csll_carta.codigonf
											, tmp_csll_carta.endereconf
											, tmp_csll_carta.bairronf
											, tmp_csll_carta.cidadenf
											, tmp_csll_carta.estadonf
											, tmp_csll_carta.cepnf
											, tmp_csll_carta.paispe
										FROM 
											(Select sp_demonstrativo_csll_new('$id_empresa', '$dt_inicio', '$dt_final')) AS Func
											, tmp_csll_carta;";
