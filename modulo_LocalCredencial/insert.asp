...
<% VerificaDireito "|INS|", BuscaDireitosFromDB("modulo_LocalCredencial",Session("ID_USER")), true %>
<%
...
function ok() { 
 <% if (CFG_WINDOW = "NORMAL") then 
  		response.write ("document.forminsert.DEFAULT_LOCATION.value='../modulo_localCredencial/default.asp';") 
	 else
...
function aplicar()      { 
  document.forminsert.DEFAULT_LOCATION.value="../modulo_localCredencial/insert.asp"; 
  if (validateRequestedFields("forminsert")) { 
            ...
            <div class="frame" id="DADOS" style="width:100%;">
                ...
                <div class="grid" style="border:0px solid #F00">
                     <div class="row">
                                ...
                                <div class="span8">
                                     <p class="input-control text " data-role="input-control"><input id="DBVAR_STR_NOMEô" name="DBVAR_STR_NOMEô" type="text" placeholder="" value="" maxlength="120"></p>
                     ...
                     <div class="row ">
                                ...
                                <div class="span8"> 
                                     <p class="input-control text " data-role="input-control"><input id="DBVAR_STR_LOCALô" name="DBVAR_STR_LOCALô" type="text" placeholder="" value="" maxlength="120"></p>
                                     <span class="tertiary-text-secondary"></span>                             
                                </div>
                     </div> 
                     <div class="row">
