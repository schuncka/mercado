...
",min(if(date_format(tbl_controle_in.dt_insert,'%Y') = '2012' and tbl_controle_in.COD_EVENTO = 300,'X',NULL)) as REABILITACAO2012"&_
",min(if(date_format(tbl_controle_in.dt_insert,'%Y') = '2013' and tbl_controle_in.COD_EVENTO = 832,'X',NULL)) as REABILITACAO2013"&_
...
" WHERE tbl_controle_in.COD_EVENTO in (300,832)"&_
...
Else
 strFILENAME = "REABILITACAO_2011_2012" & strCOD_EVENTO & "_" & strFILENAME & "_" & Replace(Date,"/","") & "_" & Replace(Time,":","")
End If
