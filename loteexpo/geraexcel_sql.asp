...
",min(if(date_format(tbl_controle_in.dt_insert,'%d/%m/%Y') = '13/01/2013' and tbl_controle_in.COD_EVENTO = 248,'X',NULL)) as SPPP2013_13JAN"&_
",min(if(date_format(tbl_controle_in.dt_insert,'%d/%m/%Y') = '14/01/2013' and tbl_controle_in.COD_EVENTO = 248,'X',NULL)) as SPPP2013_14JAN"&_
",min(if(date_format(tbl_controle_in.dt_insert,'%d/%m/%Y') = '15/01/2013' and tbl_controle_in.COD_EVENTO = 248,'X',NULL)) as SPPP2013_15JAN"&_
",min(if(date_format(tbl_controle_in.dt_insert,'%d/%m/%Y') = '16/01/2013' and tbl_controle_in.COD_EVENTO = 248,'X',NULL)) as SPPP2013_16JAN"&_
",min(if(date_format(tbl_controle_in.dt_insert,'%d/%m/%Y') = '14/01/2013' and tbl_controle_in.COD_EVENTO = 247,'X',NULL)) as CM2013_14JAN"&_
",min(if(date_format(tbl_controle_in.dt_insert,'%d/%m/%Y') = '15/01/2013' and tbl_controle_in.COD_EVENTO = 247,'X',NULL)) as CM2013_15JAN"&_
",min(if(date_format(tbl_controle_in.dt_insert,'%d/%m/%Y') = '16/01/2013' and tbl_controle_in.COD_EVENTO = 247,'X',NULL)) as CM2013_16JAN"&_
",min(if(date_format(tbl_controle_in.dt_insert,'%d/%m/%Y') = '17/01/2013' and tbl_controle_in.COD_EVENTO = 247,'X',NULL)) as CM2013_17JAN"&_
...
" WHERE tbl_controle_in.COD_EVENTO in (247,248)"&_
