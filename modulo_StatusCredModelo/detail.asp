...
Const DLD = "../modulo_StatusCredModelo/default.asp" 	' "../evento/data.asp" - 'Default Location após Deleção         				' - Campo chave...
Const TIT = "ShopIntl Passo1"    						' - Nome/Titulo sendo referencia como titulo do módulo no botão de filtro
