    ...
    <fieldset>
     ...
     <p><label>Nome Campo Cliente</label></p>
        ...
        <div class="input-control select" >
            ...
            <option value="todos"<%if (strLOJASHOW > "1") or (strLOJASHOW = "") then response.Write("selected") end if %>>[selecione]</option>
            <option value="1" <%if strLOJASHOW ="1" then response.Write("selected") end if %>>Sim</option>
            <option value="0" <%if strLOJASHOW ="0" then response.Write("selected") end if %>>Não</option>
