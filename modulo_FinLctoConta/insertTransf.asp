...
<%
 ...
 Const TIT = "Transferência - Inserção"		' - Carrega o nome da pasta onde se localiza o modulo sendo refenrencia para apresentação do modulo no botão de filtro
...
<!--div class TAB CONTROL --------------------------------------------------//-->
    <form name="forminsert" action="../modulo_FINLCTOCONTA/InsertTransfExec.asp" method="post">
	<input type="hidden" name="JSCRIPT_ACTION" value=''>
	<input type="hidden" name="DEFAULT_LOCATION" id="DEFAULT_LOCATION" value='../modulo_FINLCTOCONTA/insertTransf.asp'>
                ...
                <div class="row">
                        ...
                        <div class="span8">
                             <p class="input-control textarea " data-role="input-control">
                                <textarea name="var_obs" id="var_obsô" rows="7" ></textarea>
                             </p>
                             <span class="tertiary-text-secondary"></span>
                        </div>
                 </div>
