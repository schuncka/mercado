...
<%
 ...
 Const DLD = "../modulo_clientes/mini_Marcas/default.asp" ' "../evento/data.asp" - 'Default Location após Deleção
 Const TIT = "Marcas"  								' - Nome/Titulo sendo referencia como titulo do módulo no botão de filtro
...
strSQL = "select cod_marca,descr_marca from tbl_clientes_marcas where cod_marca = " & strCodCli
...
function ok() { 
 <% if (CFG_WINDOW = "NORMAL") then 
  		response.write ("document.formupdate.DEFAULT_LOCATION.value='../modulo_clientes/mini_marcas/default.asp';") 
	 else
...
function aplicar()      {  
  document.forminsert.DEFAULT_LOCATION.value="../modulo_clientes/mini_marcas/update.asp?var_chavereg=<%=strCodCli%>"; 
  if (validateRequestedFields("forminsert")) { 
...
<!--div class TAB CONTROL --------------------------------------------------//-->
   <form name="forminsert" id="forminsert" action="../../_database/athupdatetodb.asp" method="post">
					...
					<input type="hidden" name="RECORD_KEY_VALUE" value="<%=strCodCli%>">
                        ...
                        <div class="row">
                            ...
                            <div class="span8">
                                    <div class="input-control text info-state" data-role="input-control">
                                        <p><input id="DBVAR_STR_descr_marca" name="DBVAR_STR_descr_marca" type="text" placeholder="" value="<%=getValue(objRS,"descr_marca")%>" ></p>
                                    </div>
