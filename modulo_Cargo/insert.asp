  ...
  <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#000000">
    <tr> 
      ...
      <td width="492"><table width="492" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="arial12">
          <tr> 
                  <td bgcolor="#7DACC5">&nbsp;&nbsp;Inserção de Cargos</td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td align="center"><table width="450" border="0" cellpadding="0" cellspacing="0" class="arial11">
                      <tr> 
                        ...
                        <td width="350"> <input name="var_campo1" type="text" class="textbox100"> 
                        </td>
                      </tr>
                      <tr> 
                        <td width="100" align="right">*Descricao:&nbsp;</td>
                        <td width="350"> <input name="var_campo2" type="text" class="textbox380"> 
                        </td>
                      </tr>
                      <tr> 
                        <td width="100" align="right" valign="top">*Extra:&nbsp;</td>
                        <td width="350" align="left"><input name="var_campo3" type="text" class="textbox30"> 
                        </td>
                      </tr>
                    </table></td>
          </tr>
