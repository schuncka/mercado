...
function aplicar()      {  
  document.forminsert.DEFAULT_LOCATION.value="../modulo_clientes/mini_Produtos/update.asp?var_chavereg=<%=strCodCli%>"; 
  if (validateRequestedFields("forminsert")) { 
...
<!--div class TAB CONTROL --------------------------------------------------//-->
   <form name="forminsert" id="forminsert" action="../../_database/athupdatetodb.asp" method="post">
                    ...
                    <input type="hidden" name="RECORD_KEY_NAME" value="cod_TBL_CLIENTES_PRODUTOS"">
                    <input type="hidden" name="DEFAULT_LOCATION" value="">
					<input type="hidden" name="RECORD_KEY_VALUE" value="<%=getValue(objRS,"cod_TBL_CLIENTES_PRODUTOS")%>">
