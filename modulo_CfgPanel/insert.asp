					...
					<div class="row">
                                ...
                                <div class="span8">
                                    	<div class="input-control text info-state" data-role="input-control">
                                            <p><input id="DBVAR_STR_ROTULOô" name="DBVAR_STR_ROTULOô" type="text" placeholder="" value="" maxlength="250"></p>
                                        </div>
                     ...
                     <div class="row ">
                                ...
                                <div class="span8"> 
                                    	<div class="input-control text " data-role="input-control">
                                            <p><input id="DBVAR_STR_DESCRICAO" name="DBVAR_STR_DESCRICAO" type="text" placeholder="" value="" maxlength="250"></p>
                                        </div>
                                    <span class="tertiary-text-secondary"></span>
                                </div>
                     </div> 
                     <div class="row ">
                                ...
                                <div class="span8">
                                    	<div class="input-control text info-state" data-role="input-control">
                                            <p><input id="DBVAR_STR_LINKô" name="DBVAR_STR_LINKô" type="text" placeholder="ex.: modulo_CFGPainel/default.asp" value="" ></p>
                                        </div>
                     ...
                     <div class="row ">
                                <div class="span2" style=""><p>Parâmetros para Link:</p></div>
                                <div class="span8">
                                    	<div class="input-control text " data-role="input-control">
                                            <p><input id="DBVAR_STR_LINK_PARAM" name="DBVAR_STR_LINK_PARAM" type="text" placeholder="ex.:?par1=100&amp;par2={cod_evento}" value="" ></p>
                                        </div>
                     ...
                     <div class="row ">
                                ...
                                <div class="span8">
                                    <div class="input-control text info-state" data-role="input-control">
                                            <p><input id="DBVAR_STR_LINK_TARGETô" name="DBVAR_STR_LINK_TARGET" type="text" placeholder="ex.:_blank,_self,_top,_parent" value="_blank" ></p>
                                    </div>
                ...
                <div class="grid" style="border:0px solid #F00">
                                    	...
                                    	<div class="input-control  select size2" data-role="input-control">
                                            <p>
                                            	<select name="DBVAR_STR_TILE_VIEW" id="DBVAR_STR_TILE_VIEW" class="">
                                                    ...
                                                    <option value="PVISTA LINKS"   >PVISTA LINKS</option>
                                                </select>
                                            </p>
                                    	</div>
                                    	<div class="input-control  select size2" data-role="input-control">                                        
                                            <p>
                                                <select name="DBVAR_STR_TILE_TYPE" id="DBVAR_STR_TILE_TYPE" class="">
                                                    <option value="" selected>tile</option>
                    ...
                    <div class="row ">
                            ...
                            <p>
                                <div class="input-control text select size2 " data-role="input-control">
                                    <p>
                                        ...
                                        <option value="<%=trim(arrICON(i))%>"  <%if  trim(arrICON(i))="" then response.Write("selected") end if	%>><%=trim(arrICON(i))%></option>
                                        <% Next %>
                                        </select>
                                    </p>
                                </div>
                                ...
                                <div class="input-control text select size2 " data-role="input-control">
                                    <p>
                                        ...
                                        <option value="<%=trim(arrBG(i))%>"  <%if  trim(arrBG(i))="bg-darkGreen" then response.Write("selected") end if	%>><%=trim(arrBG(i))%></option>
                                        <% Next %>
                                        </select>
                                    </p>
                                </div>
                     ...
                     <div class="row ">
                                ...
                                <div class="span8">
                                    	<div class="input-control text " data-role="input-control">
                                            <p><input class="size2" id="DBVAR_STR_ORDEM" name="DBVAR_STR_ORDEM" type="text" placeholder="posição no atalho" value="" maxlength="9" onKeyPress="return validateNumKey(event);"></p>
                                        </div>
                                    <span class="tertiary-text-secondary"></span>
                                </div>
                     </div>  
