...
<?php
	  ...
	  <tr>
		<td><table width="100%" border="1" class="bordasimples1">
			...
			<tr>
			  ...
			  <td width="69%">Condições válidas para renovação até <?php echo getValue($objRSevento,"dt_limite_contrato"); ?>, com pagamento <?php if ($var_opcao_contrato == "1") { echo(" em até 5 parcelas. "); } else { echo(" de 6 a 11 parcelas. "); }?></td>
			</tr>
		  </table></td>
	  </tr>
	</table>
	...
	<table width="100%" border="0" class="bordasimples1">
	  <tr>
		...
		<td width="98%" align="justify"><div align="justify"><b>OBJETO DO CONTRATO:</b> A SÃO PAULO FEIRAS COMERCIAIS LTDA, é a promotora exclusiva e única responsável pela Organização, Planejamento, Promoção e Administração da Feira <?php echo getValue($objRSevento, "nome_completo"); ?> - <?php echo getValue($objRSevento, "edicao"); ?>ª
		 -  <?php   echo getValue($objRSevento,"nome_oficial");   ?> 
	  ...
	  <tr>
		...
		<td align="justify"><div align="justify">Energia Elétrica Instalada/Obrigatória: Será cobrado neste contrato o equivalente a 0,090 KVA de energia elétrica instalada por m² no espaço
	...
	<b>OBS: POSIÇÕES DOS ESTANDES SUJEITAS A AJUSTES ATÉ FEVEREIRO/2014</b><br><br>
	...
	<table width="100%" border="0" class="bordasimples1">
	  ...
	  <tr>
		...
		<td align="justify"><div align="justify"><b>No caso de atraso de uma ou mais parcelas o EXPOSITOR perderá o desconto comercial concedido, sendo o mesmo incorporado nas
		  parcelas restantes ou emitido boleto complementar.</b></div></td>
	  </tr>
	  <tr>
		<td valign="top"><b>2.</b></td>
