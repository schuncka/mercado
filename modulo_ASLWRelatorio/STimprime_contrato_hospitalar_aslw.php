...
<?php
	...
	foreach($objResultcontrato as $objRScontratoRenovacao){
		...
		$strSQLpedido = "SELECT nomemapa,
						...
						FROM ped_pedidos LEFT JOIN cad_pavilhao ON ped_pedidos.pavilhaope = cad_pavilhao.idpavilhao
		...
		$strSQLevento = "SELECT 
						...
						AND cad_evento.idevento = (	SELECT cad_evento.idevento
													...
													AND DATE_PART('year', cad_evento.dt_inicio) = ( SELECT DATE_PART('year', dt_inicio) +1
																									FROM cad_evento 
		...
		<td><table width="100%" border="1" class="bordasimples1">
			<tr>
			 <?php /*?> <td width="20%" align="center"><img src="../../<?php echo $dir_cliente; ?>/upload/LogoContrato_<?php echo $id_mercado; ?>.jpg" border="0"></td><?php */?>
              <td width="20%" align="center" style="vertical-align:text-bottom; font-size:24px; text-transform:capitalize; font-weight:bold; " nowrap><?php echo(getValue($objRSevento,"nome_completo"));?></td>
			...
			<tr>
			  <td width="20%" align="center" bgcolor="#000000"><font color="#FFFFFF" size="1"><b><?php echo getValue($objRSevento,"dia_inicio")." a ".getValue($objRSevento,"dia_fim")." | ".nomeMes(getValue($objRSevento,"mes_fim"))." | " .getValue($objRSevento,"ano_fim")  ?></b></font></td>
			  <td width="1%" align="center">&nbsp;</td>
	...
	<div align="justify"><b>I. CONTRATANTES</b>
	  ...
	  SÃO PAULO FEIRAS COMERCIAIS LTDA., inscrita no CNPJ nº 02.995.701/0001-33 <?php // echo getValue($objRSempresa, "ecnpj"); ?> com sede na Rua Padre Jo&atilde;o Manuel, 923 Conj. 61/62- 6&ordm; Andar - Cerqueira C&eacute;sar - Fone <?php echo getValue($objRSempresa, "etele"); ?> - Fax<?php echo getValue($objRSempresa, "efax"); ?> - CEP 01411-001 - S&atilde;o Paulo/SP - Brasil, promotora e organizadora da <?php echo getValue($objRSevento, "nome_completo"); ?> um empreendimento da <?php echo getValue($objRSevento, "empreendimento"); ?>.<br>
	<b>2. EXPOSITOR</b>
	</div>
	...
	<table width="100%" border="0" class="bordasimples1">
	  <tr>
		...
		<td width="98%" align="justify"><div align="justify"><b>OBJETO DO CONTRATO:</b> A SÃO PAULO FEIRAS COMERCIAIS LTDA, é a promotora exclusiva e única responsável pela Organização, Planejamento, Promoção e Administração da Feira <?php echo getValue($objRSevento, "nome_completo"); ?> - <?php echo getValue($objRSevento, "edicao"); ?>ª edição
		<?php // -     echo getValue($objRSevento,"nome_oficial");   ?> 
	...
	<table width="82%" border="0">
	  <tr>
		...
		<td width="54%"  colspan="3" align="left"><b><?php echo getValue($objRSpedido, "localpe");  if (getValue($objRSpedido, "pavilhaope") <> '') {echo " - " . getValue($objRSpedido, "descrpavilhao");}; ?></b></td>
	  </tr>
	</table>
