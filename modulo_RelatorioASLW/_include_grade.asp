                    ...
                    <div class="button-dropdown place-left" style="width:20px; height:20px; border:0px solid #F00;">
                           <img class="dropdown-toggle" src="../img/icon_action.gif"  >                            
                             ...
                             <!--DELETE comentado pois neste modo procede que não haja exclusões de registros sem a devida supervisão//-->
                                ...
                                <li>
                                	<a class="dropdown-toggle" href="#">VISUALIZAR</a>
                                	 <ul class="dropdown-menu " data-show="hover" data-role="dropdown">
                                        <li><a href="javascript:AbreJanelaPAGE('<%=GetValue(objRS,"EXECUTOR")%>?var_chavereg=<%=GetValue(objRS,DKN)%>','680', '460')">EXECUTAR</a></li>
                                        <li><a href="javascript:AbreJanelaPAGE('<%=GetValue(objRS,"EXECUTOR")%>?var_chavereg=<%=GetValue(objRS,DKN)%>&var_acao=.xls','480', '360')">EXPORTAR EXCEL</a></li>
                                	    <li><%=AthWindow ("detail.asp?var_chavereg=" & GetValue(objRS,DKN), 600, 480, "DETALHES")%></li>
                                    </ul>
                               </li>
                                 <li class="divider">
