...
<?php
				try{
					...
					$strSQL = " SELECT DISTINCT 
												...
												cad_evento.site
									FROM cad_empresa 
									INNER JOIN vw_monta_senha_expositor ON (cad_empresa.idmercado = vw_monta_senha_expositor.idmercado) 
									INNER JOIN cad_cadastro ON (vw_monta_senha_expositor.codigo = cad_cadastro.codigo AND vw_monta_senha_expositor.idmercado = cad_cadastro.idmercado) 
									INNER JOIN cad_evento ON (vw_monta_senha_expositor.idevento = cad_evento.idevento)
									INNER JOIN cad_tipo_evento ON (cad_evento.cod_tipo_evento = cad_tipo_evento.cod_tipo_evento)
									WHERE cad_evento.idevento ILIKE '" . $var_idevento . "'
...
<table align="center" bgcolor="#FFFFFF" width="92%" border="0">
  <tr>
  	<td><img width="600" height="80" src="<?php echo '../img/logos/cab_'.$datawide_lang.'_'.$id_evento.'.jpg'; ?>"></td>
  </tr>
  <tr>
  ...
  <tr align="center">
    <td><hr>
		<img style="position:relative" border="0" width="580" height="30" src="<?php echo '../img/logos/rod_'.$datawide_lang.'_'.$id_evento.'.jpg'; ?>"></td>
  </tr>
</table>
<!-- Quebra de página-->
<div class="folha"></div>
