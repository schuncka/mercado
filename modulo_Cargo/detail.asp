...
<form name="formdetail" action="update.asp" method="POST">
  <input type="hidden" name="var_chavereg" value="<%=objRS("COD_CARGOS")%>">
<tr> 
  ...
  <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#000000">
    <tr> 
      ...
      <td width="492"><table width="492" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="arial12">
          <tr> 
                <td bgcolor="#7DACC5">&nbsp;&nbsp;Detalhes de Cargos</td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td align="center"> <table width="450" border="0" cellpadding="0" cellspacing="0" class="arial11">
                ...
                <tr> 
                  ...
                  <td width="350"><strong><%=ObjRS("CAMPO1")%></strong></td>
                </tr>
                <tr> 
                  <td width="100" align="right">Descrição:&nbsp;</td>
                  <td width="350"><strong><%=ObjRS("CAMPO2")%></strong></td>
                </tr>
                <tr> 
                  <td width="100" align="right">Extra:&nbsp;</td>
                  <td width="350"><strong><%=ObjRS("CAMPO3")%></strong></td>
                </tr>
              </table></td>
          </tr>
          <tr> 
