									...
									<table border="0" cellpadding="0" cellspacing="0" width="90%">
										<tr>
											...
											<td>
												...
												<a href="javascript:UploadImage('form_documentos','dbvar_str_documento','\\AreaRestrita<% If objRS("LANG") <> "PT" Then Response.Write("Intl") End If %>\\download\\');">
										...
										<tr>
											...
											<td>
												<select name="dbvar_str_area" class="textbox180">
													<option value=""></option>
													<% MontaCombo "SELECT status FROM tbl_status_cred ORDER BY status", "status", "status", objRS("AREA") %>
												</select>
											</td>
										</tr>
									</table>
