...
<?php
	...
	foreach($objResultcontrato as $objRScontratoRenovacao){
		...
		$strSQLpedido = "SELECT nomemapa,
								...
								descrpavilhao,
								localpe,
								CASE WHEN descrpavilhao IS NULL THEN localpe ELSE localpe || ' - ' || descrpavilhao END AS localizacao
		...
		$strSQLevento = "SELECT 
								...
								, to_char(cad_evento.dt_inicio,'dd') as dia_inicio 
								, to_char(cad_evento.dt_fim ,'dd') as dia_fim 
								, to_char(cad_evento.dt_fim ,'mm') as mes_fim 
								, to_char(cad_evento.dt_fim ,'yyyy') as ano_fim
								, cad_evento.dtlimite								   
						...
						FROM cad_evento, cad_tipo_evento
						WHERE cad_evento.cod_tipo_evento = cad_tipo_evento.cod_tipo_evento
						AND cad_evento.idevento = (	SELECT idevento
													FROM cad_evento 
													WHERE idmercado = '".$id_mercado."' 
	...
	<table width="82%" border="0">
	  <tr>
		...
		<td width="54%"  colspan="3" align="left"><b><?php echo getValue($objRSpedido, "localizacao");?></b></td>
	  </tr>
	</table>
	...
	<table width="100%" border="0" class="bordasimples1">
	  ...
	  <tr>
		<td valign="top"><b>3.</b></td>
		<td align="justify"><div align="justify">Energia Elétrica Instalada/Obrigatória: Será cobrado neste contrato o equivalente a 0,070 KVA de energia elétrica instalada por m² no espaço
		disponibilizado, conforme item 5.2 do Regulamento Geral, ao preço de: . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  .  . . . .<b>R$
		<?php echo number_format( getValue($objRSrenovacao, "energia" ), 2, ',', '.'); ?> por m²</b></div></td>
	  </tr>
	 <tr>
		<td valign="top"><b>4.</b></td>
