...
<table width="100%" border="0" class="bordasimples" style="border-right:none; border-left:none" bgcolor="#FFFFFF">  
  ...
  <tr>
    ...
    <td colspan="1" width="25%" align="right" style="border-right:none; border-left:none; border-top:none">Área Vendida</td>
  </tr>
</table>
...
<?PHP   if ($var_quebra2 == true){?>
	...
	<table width="100%" border="0">
	  <tr>
		...
		<td width="70%"> Total de área vendida pelo Representante <?php echo getValue($objRS,"nomerepre")?> </td>
