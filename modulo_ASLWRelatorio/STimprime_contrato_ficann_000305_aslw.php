...
<?php
	...
	foreach($objResultcontrato as $objRScontratoRenovacao){
		...
		$strSQLevento = "SELECT 
						...
						FROM cad_evento, cad_tipo_evento
						WHERE cad_evento.cod_tipo_evento = cad_tipo_evento.cod_tipo_evento
						AND cad_evento.idevento = '000305' ";
		...
		<td><table width="100%" border="1" class="bordasimples1">
			<tr>
			 <?php /*?> <td width="20%" align="center"><img src="../../<?php echo $dir_cliente; ?>/upload/LogoContrato_<?php echo $id_mercado; ?>.jpg" border="0"></td><?php */?>
			  ...
			  <td colspan="2" width="79%"><?php echo getValue($objRSevento,"nome_completo")." - ".getValue($objRSevento,"edicao")."ª"; ?> 
	...
	<div align="justify"><b>I. CONTRATANTES</b>
	  <br>
	  <b>1. PROMOTORA E ORGANIZADORA: </b>	  FICANN FEIRAS COMERCIAIS DO NORTE E NORDESTE LTDA., inscrita no CNPJ nº 16.943.233/0001-68 
	...
	<table width="100%" border="0" class="bordasimples1">
	  ...
	  <tr>
		...
		<td><div align="left"><strong><?php 
			//Não exibe mais porque deslocava o resto pra baixo e gerava problema na impressão porque assinatura 
			//ficava quebrada; acontecia quando expositor tinha muitas marcas, como CARBONGEL
			//Solução de "reticências" não passou, então Bruna pediu para remover todo campo - by Clv 05/05/2011
			/*
	...
	<table width="100%" border="0" class="bordasimples1">
	  <tr>
		...
		<td width="98%" align="justify"><div align="justify"><b>OBJETO DO CONTRATO:</b> FICANN FEIRAS COMERCIAIS DO NORTE E NORDESTE LTDA, é a promotora exclusiva e única responsável pela Organização, Planejamento, Promoção e Administração da Feira <?php echo getValue($objRSevento, "nome_completo"); ?> - <?php //echo getValue($objRSevento, "edicao"); ?>
		 -  <?php   echo getValue($objRSevento,"nome_oficial");   ?> 
		 -	<?php echo getValue($objRSevento,"dia_inicio")." a ". TranslateDate(getValue($objRSevento,"dt_fim")); ?> - <?php echo getValue($objRSevento,"pavilhao"); ?>, localizada na cidade de Fortaleza/CE, sendo de sua responsabilidade exclusiva prover todos os serviços necessários e/ou convenientes à realização desta Feira, nos termos do Regulamento Geral, que faz parte integrante e complementar deste contrato. </div></td>
	  </tr>
	  <tr>
		<td valign="top"><b>1.</b></td>
		<td align="justify"><div align="justify">O EXPOSITOR participará da Feira <?php echo getValue($objRSevento, "nome_completo"); ?> ocupando um ou mais espaços, com tipo de montagem padr&atilde;o, a ele disponibilizados pela
		FICANN FEIRAS COMERCIAIS DO NORTE E NORDESTE LTDA., ao preço de: . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .<b>R$ <?php echo number_format(getValue($objRSrenovacao, "area".$var_opcao_contrato), 2, ',', '.'); ?> por m²</b></div></td>
	  </tr>
	  <!-- tr>
	  ...
	  <tr>
		...
		disponibilizado, conforme item 6.2.6 do Regulamento Geral, ao preço de: . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  .  . . . .<b>R$
	...
	<?php
		...
		//  $strSQLprodutos = "select * from ped_pedidos_renovacao_evento a where a.idpedido = '".getValue($objRSpedido ,"idpedido")."' AND idmercado ilike '".$id_mercado."' order by idproduto";	
			...
			$strSQLprodutos .= "   AND ped_pedidos_renovacao_evento.idevento LIKE '000305'"; /* provisório este relatório renova especificamente o evento 000305 FICANN */
	...
	?>
	   <tr>
		...
		<td align="right">
		<?php 
		// ATENÇÃO: seria "AR0001" pra ser usado como pdoduto principal, mas neste caso dos eventos 000305 e 000306 eles trocaram
	...
	<table width="100%" border="0" class="bordasimples1">
	  <tr>
		...
		<td align="justify"><div align="justify">O EXPOSITOR compromete-se a pagar o valor de R$ <?php echo number_format($valor_total_bruto, 2, ',', '.'); ?> ( <?php echo valorPorExtenso($valor_total_bruto); ?> ), sobre o qual incidirá o desconto comercial de ___% referente ao valor do espaço com montagem padrão, em ___ parcela(s) mensal(ais), com primeiro vencimento em ___/___/___ . Para pagamento até a data do vencimento, se aplicará desconto de pontualidade de ____%  no boleto bancário.</div></td>
	  </tr>
	  <tr>
		<td valign="top"><b>2.</b></td>
		<td align="justify"><div align="justify">O EXPOSITOR autoriza expressamente a FICANN FEIRAS COMERCIAIS DO NORTE E NORDESTE LTDA a emitir os boletos de cobrança bancária, originários do presente contrato, com vencimento
	  ...
	  <tr>
		...
		<td align="justify"><div align="justify">Os Contratantes elegem o Foro da Capital do Estado de Cear&aacute;, onde será realizada a Feira, para dirimirem quaisquer dúvidas provenientes da
...
com sede na Rua VICENTE LINHARES, 500 CONJUNTOS 801, 802 E 803 - Bairro Aldeota Fone <?php echo getValue($objRSempresa, "etele"); ?> - Fax<?php echo getValue($objRSempresa, "efax"); ?> - CEP 60.135-270 -  FORTALEZA/CE - BRASIL - contato@ficann.com.br - www.ficann.com.br, promotora e organizadora da <?php echo getValue($objRSevento, "nome_completo"); ?>  um empreendimento da <?php echo getValue($objRSevento, "empreendimento"); ?>.<br>
	...
	<table width="100%" border="0" class="bordasimples1">
	  ...
	  <tr>
		<td valign="top"><b>1.</b></td>
		<td align="justify"><div align="justify">O EXPOSITOR participará da Feira <?php echo getValue($objRSevento, "nome_completo"); ?>  ocupando um ou mais espaços, com tipo de montagem padrão ou não, a ele disponibilizados pela
		FICANN FEIRAS COMERCIAIS DO NORTE E NORDESTE LTDA., ao preço de: . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .<b>R$ <?php echo number_format(getValue($objRSrenovacao, "area".$var_opcao_contrato), 2, ',', '.'); ?> por m²</b></div></td>
	  </tr>
	  <!---
	  <tr>
