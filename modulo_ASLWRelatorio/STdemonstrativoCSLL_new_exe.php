...
<?php
					...
					// SQL Principal	
					try{
					$strSQL = "SELECT   SUM(ped_nota_fiscal.VALORNF)    AS SomaDeVALORNF,
         ...
         date_part('MONTH', ped_pedidos_parcelamento.datapgto) AS MES,  
         CAD_EMPRESA.ERODAPE,
         CAD_EMPRESA.ERAZAO,
...
FROM     (CAD_EMPRESA
         ...
         ON       (ped_nota_fiscal.idmercado    = PED_PEDIDOS_PARCELAMENTO.idmercado)
         AND      (ped_nota_fiscal.NRODUPLICATA = PED_PEDIDOS_PARCELAMENTO.NRODUPLICATA)
	...
	<table width="100%"  class="bordasimples" >
      ...
      <table width="100%"  class="bordasimples" >
        ...
        <?php
					// SQL Secundário	
					try{
					$strSQLsecundario = "SELECT   SUM(ped_nota_fiscal.VALORNF)    AS SomaDeVALORNF,
         SUM(PED_PEDIDOS_PARCELAMENTO.VLRCOFINS) AS COFINS,
         SUM(PED_PEDIDOS_PARCELAMENTO.VLRPIS)    AS PIS,
         SUM(PED_PEDIDOS_PARCELAMENTO.VLRCSLL)   AS CSLL,
