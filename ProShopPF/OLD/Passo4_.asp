...
<%
 ...
 Dim strLinkLimpo, strProshopTextoFinal
	...
	'response.write("<br>link:"&strLinkLimpo)
...
strHTML = strHTML & "    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':"
strHTML = strHTML & "    new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],"
strHTML = strHTML & "    j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src="
strHTML = strHTML & "    'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);"
strHTML = strHTML & "    })(window,document,'script','dataLayer','"&session("METRO_ProShopPF_strGtmId")&"');</script>"
...
strHTML = strHTML & "<body class='metro' style='background-color:#F8F8F8; -webkit-print-color-adjust: exact;'>"&vbnewline
 ...
 If session("METRO_ProShopPF_strGtmId") <> "" Then 
strHTML = strHTML & "<!-- Google Tag Manager (noscript) -->"&vbnewline
strHTML = strHTML & " <noscript><iframe src='https://www.googletagmanager.com/ns.html?id="&session("METRO_ProShopPF_strGtmId")&"'"&vbnewline
strHTML = strHTML & " height='0' width='0' style='display:none;visibility:hidden'></iframe></noscript>"&vbnewline
strHTML = strHTML & " <!-- End Google Tag Manager (noscript) -->"&vbnewline
 End If 
...
strHTML = strHTML & "                     <div class='span114' style='background-color:#FFF;'><!-- level 1 column //-->"&vbnewline
strHTML = strHTML & "                         <div sclass='row'>"&vbnewline
strHTML = strHTML & "                             <img class='' src='"&strLinkLimpo&"imgdin/"&session("METRO_ProShopPF_strCabecalhoLoja")&"' style='margin-bottom:15px;margin-top:15px;'>"&vbnewline
...
strHTML = strHTML & "                    <a href='"&strLINK&"?cod_evento="&strCOD_EVENTO&"&lng="&strLng&strCat&"' class='element'><strong>"&session("METRO_ProShopPF_strNomeEvento")&"</strong></a>"&vbnewline
...
strHTMLiFrame = strHTMLiFrame & "                                      <iframe src='"&session("METRO_ProShopPF_strGoogleMapsEvento")&"' width='100%' height='400' frameborder='0' style='border:0' allowfullscreen></iframe>"&vbnewline
                                                   End If 
