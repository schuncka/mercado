	...
	<div class="grid">
		...
		<div class="row">        
			<div class="span6">
				...
				<% if strLng = "BR" Then %>
					...
					<div class="input-control text" data-role="input-control">
						<input type="number" style="background-color:#FFFFCC;" placeholder="<%=objLang.SearchIndex("placeholder_cpf",0)%>" autofocus onKeyPress="Javascript:return validateNumKey(event);return false;" maxlength="11" id="var_id_numdoc1_ô" name="var_id_numdoc1" onblur="javascript:validaCpf(this.value);return false;">
				...
				<div class="input-control text size1" data-role="input-control">
					<input type="number" <%if strLng = "BR" then%> value="55" <%Else%> placeholder="<%=objLang.SearchIndex("placeholder_ddi",0)%>" <%End if%>  autofocus id="<%=tornaCampoObrigatorio(arrValCampos,"var_ddi3")%>" name="var_ddi3" onKeyPress="Javascript:return validateNumKey(event);return false;" maxlength="3">
					<button class="btn-clear" tabindex="-1"></button>
				</div>

				<div class="input-control text size1" data-role="input-control">
					<input type="number" placeholder="<%=objLang.SearchIndex("placeholder_ddd",0)%>" autofocus id="<%=tornaCampoObrigatorio(arrValCampos,"var_ddd3")%>" name="var_ddd3" onKeyPress="Javascript:return validateNumKey(event);return false;" maxlength="3">
					<button class="btn-clear" tabindex="-1"></button>
				</div>

				<div class="input-control text size2" data-role="input-control">
					<input type="number" placeholder="<%=objLang.SearchIndex("placeholder_fone",0)%>" autofocus id="<%=tornaCampoObrigatorio(arrValCampos, "var_fone3")%>" name="var_fone3" onKeyPress="Javascript:return validateNumKey(event);return false;" maxlength="40" onblur="javascript: concatenaCampos();return false;">
					<button class="btn-clear" tabindex="-1"></button>
				</div>
				
				<label><%=objLang.SearchIndex("fone_comercial",0)%></label>
				<div class="input-control text size1" data-role="input-control">
					<input type="number" <%if strLng = "BR" then%> value="55" <%Else%> placeholder="<%=objLang.SearchIndex("placeholder_ddi",0)%>" <%End if%> autofocus id="<%=tornaCampoObrigatorio(arrValCampos, "var_ddi4")%>" name="var_ddi4" onKeyPress="Javascript:return validateNumKey(event);return false;" maxlength="3">
					<button class="btn-clear" tabindex="-1"></button>
				</div>

				<div class="input-control text size1" data-role="input-control">
					<input type="number" placeholder="<%=objLang.SearchIndex("placeholder_ddd",0)%>" autofocus id="<%=tornaCampoObrigatorio(arrValCampos, "var_ddd4")%>" name="var_ddd4" onKeyPress="Javascript:return validateNumKey(event);return false;" maxlength="3">
					<button class="btn-clear" tabindex="-1"></button>
				</div>

				<div class="input-control text size2" data-role="input-control">
					<input type="number" placeholder="<%=objLang.SearchIndex("placeholder_fone",0)%>" autofocus id="<%=tornaCampoObrigatorio(arrValCampos, "var_fone4")%>" name="var_fone4" onKeyPress="Javascript:return validateNumKey(event);return false;" maxlength="40">
					<button class="btn-clear" tabindex="-1"></button>
				</div>

				<label><%=objLang.SearchIndex("fone_residencial",0)%></label>
				<div class="input-control text size1" data-role="input-control">
					<input type="number" <%if strLng = "BR" then%> value="55" <%Else%> placeholder="<%=objLang.SearchIndex("placeholder_ddi",0)%>" <%End if%> autofocus id="var_ddi1" name="var_ddi1" onKeyPress="Javascript:return validateNumKey(event);return false;" maxlength="3">
					<button class="btn-clear" tabindex="-1"></button>
				</div>

				<div class="input-control text size1" data-role="input-control">
					<input type="number" placeholder="<%=objLang.SearchIndex("placeholder_ddd",0)%>" autofocus id="<%=tornaCampoObrigatorio(arrValCampos, "var_ddd1")%>" name="var_ddd1" onKeyPress="Javascript:return validateNumKey(event);return false;" maxlength="3">
					<button class="btn-clear" tabindex="-1"></button>
				</div>

				<div class="input-control text size2" data-role="input-control">
					<input type="number" placeholder="<%=objLang.SearchIndex("placeholder_fone",0)%>" autofocus id="<%=tornaCampoObrigatorio(arrValCampos, "var_fone1")%>" name="var_fone1" onKeyPress="Javascript:return validateNumKey(event);return false;" maxlength="40">
					<button class="btn-clear" tabindex="-1"></button>
				</div>
			...
			<%if strLng = "BR" Then%>
				...
				<div class="input-control text" data-role="input-control">
					<input type="number" placeholder="<%=objLang.SearchIndex("placeholder_cep",0)%>" autofocus id="<%=tornaCampoObrigatorio(arrValCampos, "var_cep")%>" name="var_cep" onblur="javascript:buscaDadoCep(this.value);return false;" onKeyPress="Javascript:return validateNumKey(event);return false;" maxlength="8">
					<button class="btn-clear" tabindex="-1"></button>
				</div>                    
			<% else %>         
				<label><%=objLang.SearchIndex("cep",0)%></label>
			...
			<legend><%=objLang.SearchIndex("empresa_entidade",0)%></legend>
   			<%if strLng = "BR" then%>
				...
				<div class="input-control text" data-role="input-control">
					<input type="number" placeholder="<%=objLang.SearchIndex("placeholder_cnpj",0)%>" id="<%=tornaCampoObrigatorio(arrValCampos, "var_cnpj")%>" name="var_cnpj" onblur="javascript:buscaDadosEntidade(this.value);return false;" onKeyPress="Javascript:return validateNumKey(event);return false;" maxlength="14">
					<button class="btn-clear" tabindex="-1"></button>
				</div>
			<%else %>
				<label><%=objLang.SearchIndex("cnpj",0)%></label>
