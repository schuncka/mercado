...
%>
	...
	Case "PREPARA":
		...
		%>
		<form name="FormImport2" id="FormImport2" action="crapr_importexcel.asp" method="post">
	...
	<form name="FormImport" id="FormImport" action="crapr_importexcel.asp" method="post">
