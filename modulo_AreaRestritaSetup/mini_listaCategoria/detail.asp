...
<%
 ...
 Const TIT = "Cadastro Caex"     ' - Carrega o nome da pasta onde se localiza o modulo sendo refenrencia para apresentação do modulo no botão de filtro
 Const DKN = "COD_STATUS_PRECO"	
 Const DLD = "../modulo_AreaRestritaSetup/mini_listaCategoria/default.asp"
 Const LTB = "TBL_STATUS_PRECO"
