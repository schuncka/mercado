...
Dim strAgrupamento
Function montaForm(prTipo, prTermoTraducao, prTamanho, prNameField, prObrigatorio, prValue, prPlaceholder, prLength, prJavaScript, prFocus, prRadioValue1, prRadioValue2, pradiolabel1, pradiolabel2, pr_Combo_SQL, pr_Combo_colValue, pr_Combo_colText, pr_Combo_Codigo, pr_divId, pr_style, pr_radioCheck1, pr_radioCheck2)
	Dim strField
