...
<% VerificaDireito "|INS|", BuscaDireitosFromDB("mini_Documentacao",Session("METRO_USER_ID_USER")), true %>
<%
 ...
 Dim  strCOD_EVENTO,strIMG, strCODCLI

strCODCLI = Replace(GetParam("var_codcli"),"'","''")
...
function ok() { 
 <% if (CFG_WINDOW = "NORMAL") then 
  		response.write ("document.formupdate.DEFAULT_LOCATION.value='../modulo_Evento/mini_Documentacao/default.asp';") 
	 else
...
function aplicar()      {  
  document.forminsert.DEFAULT_LOCATION.value="../modulo_clientes/mini_Documentacao/insert.asp?var_cod_evento=<%=strCOD_EVENTO%>"; 
  if (validateRequestedFields("forminsert")) { 
...
<!--div class TAB CONTROL --------------------------------------------------//-->
                    ...
                    <input type="hidden" name="DBVAR_STR_CodigoDoCliente" id="DBVAR_STR_CodigoDoCliente" value="<%=strCODCLI%>" >
                ...
                <div class="grid" style="border:0px solid #F00">
                    ...
                    <div class="span2"><p>Tipo</p></div>
                        <div class="span8">
                                <div class="input-control select info-state" data-role="input-control">
                                    <select id="DBVAR_STR_COD_TBL_DOCUMENTACAO_CLIENTE" name="DBVAR_STR_COD_TBL_DOCUMENTACAO_CLIENTE">
                                        ...
                                        <%=montaComboReturn("select cod_doc, nome_doc from tbl_Tipo_Documentacao order by 2", "cod_doc", "nome_doc","") %>
                                    </select>                                        
                                </div>
                      ...
                      <div class="row">
                                ...
                                <div class="span8">
                                    <p class="input-control file " data-role="input-control"> 
                                            <input type="text" name="DBVAR_STR_DOCUMENTO" id="DBVAR_STR_DOCUMENTO" value=""  />
                      ...
                      <div class="row">
                                ...
                                <div class="span8">
                                     <p class="input-control text" data-role="input-control"><input type="text" name="DBVAR_STR_Especificacao" id="DBVAR_STR_Especificacao" value="" maxlength="50"></p>
                                     <span class="tertiary-text-secondary"></span>
                                </div>
                     </div>
                            ...
                            <div class="span8">
                                ...
                                <div class="input-control text size3" data-role="input-control">
                                    <p class="input-control text span3" data-role="datepicker"  data-format="dd/mm/yyyy" data-position="top|bottom" data-effect="none|slide|fade">
                                        <input id="DBVAR_DATETIME_dt_entrega" name="DBVAR_DATETIME_dt_entrega" type="text" placeholder="" value="<%=date()%>" maxlength="11">
