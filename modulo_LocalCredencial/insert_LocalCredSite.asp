...
<%
 ...
 Dim  strCODIGO,strCODLOCALCREDENCIAL,strCODLOCALCREDENCIALSITE, strNOME, strLOCAL, strDESCRICAO
...
' Monta SQL e abre a consulta ----------------------------------------------------------------------------------
 ...
 strSQL = strSQL & "		  , COD_LOCAL_CREDENCIAL"		  
 strSQL = strSQL & "		  , COD_EVENTO"		  
 strSQL = strSQL & "		  , NOME"
 strSQL = strSQL & "		  , LOCAL "
 strSQL = strSQL & "		  , OBS "
 strSQL = strSQL & "    FROM " & LTB 
 strSQL = strSQL & "    WHERE COD_LOCAL_CREDENCIAL_SITE = COD_LOCAL_CREDENCIAL_SITE " 
 ...
 strFields = "COD_LOCAL_CREDENCIAL_SITE,COD_LOCAL_CREDENCIAL,COD_EVENTO, NOME, LOCAL, OBS" 
 arrFields = Split(strFields,",")        

 arrLabels = Array("COD"              ,  "COD_LOCAL_CRED" ,  "COD EVENTO" 	   ,  "NOME" 	,  "LOCAL"  ,   "OBS"   )
 ...
 arrWidth  = Array("2%"               ,  "10%" 				  ,     "20%"  		   ,   "20%"    ,    "20%"  ,"20%"  	)     'Obs.:[somar 98%] ou deixar todos vazios
' ----------------------------------------------------------------------------------------------------------------------------
        ...
        <div style="width:100%;display:inline-block"> 
            ...
            <div class="accordion place-left"  style="z-index:10; position:absolute; top:0px;">
                <div class="accordion-frame" style="border:0px solid #F00;">
                    <a class="heading text-left fg-active-black" href="#" style="height:45px; background:#CCC" onClick="window.location.reload();">
