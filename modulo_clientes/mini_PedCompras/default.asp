...
strSQL = strSQL &"	order by t1.data desc"
 ...
 arrLabels = Array("Contr"                  , "Data"              , "Comprador" , "Produto", "QtdaTon"          , "E-mail"                 )
 arrSort   = Array("sortable-numeric"       , "sortable-date-dmy" , "sortable" , "sortable"      ) 'Obs.:"sortable-date-dmy", "sortable-currency", "sortable-numeric", "sortable" 
