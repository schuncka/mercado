...
foreach($objResult as $objRS){
	...
	if ($var_cont == 10) {
		echo "<div class='folha'></div><br><br><br>"; 
		$var_cont = 0; 
	}
	if ($var_lado == true) { 
		$var_lado = false; ?>
<table width="50%" border="0" align="left">  
  <tr>
     <td width="45%"><div class='campos'><b><?php echo $var_nome; ?></b></div></td>
  </tr>
  <tr>
    <td width="45%"><div class='campos'><b><?php echo getValue($objRS,"nomemont"); ?></b></div></td>
  </tr>
  <tr>
    <td width="45%"><div class='campos'><?php echo getValue($objRS,"endereco").getValue($objRS,"bairro"); ?></div></td>
  </tr>
  <tr>
	<td width="45%"><div class='campos'><b><?php echo getValue($objRS,"cep"); ?></b>&nbsp;<?php echo getValue($objRS,"cidade") . getValue($objRS,"estado"); ?></div></td>
  </tr>
</table>
	<?php 
  	} 
  	else {  
	  	$var_lado = true; $var_cont++;
		?>
<table width="60%" border="0" >  
  <tr>
     <td width="15%"></td>
     <td width="85%"><div class='campos'><b><?php echo $var_nome; ?></b></div></td>
  </tr>
  <tr>
    <td width="15%"></td>
    <td width="85%"><div class='campos'><b><?php echo getValue($objRS,"nomemont"); ?></b></div></td>
  </tr>
  <tr>
    <td width="15%"></td>
    <td width="85%"><div class='campos'><?php echo getValue($objRS,"endereco").getValue($objRS,"bairro"); ?></div></td>
  </tr>
  <tr>
	<td width="15%"></td>
	<td width="85%"><div class='campos'><b><?php echo getValue($objRS,"cep"); ?></b>&nbsp;<?php echo getValue($objRS,"cidade") . getValue($objRS,"estado"); ?></div></td>
  </tr>
</table>
