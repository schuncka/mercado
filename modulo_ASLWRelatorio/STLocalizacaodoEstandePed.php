...
<table align="center" bgcolor="#FFFFFF" width="100%" border="0">
  	...
  	<tr>
  		<td colspan="2">
			<font size=2>Gostariamos de informá-lo que seu estande na <?php echo getValue($objRS,"nome_completo"); ?>  está localizado conforme dados abaixo:</font><BR><BR>
  	  		<table align="center" bgcolor="#FFFFFF" width="90%" border="1">
				<tr>
	 				<td style="border:none;">
						<font size=2>LOCALIZAÇÂO: <b><?php echo getValue($objRS,"localiz") ?></b><BR>TIPO DE ÁREA:</font><font size="2" color="#FF0000"> <b><?php echo getValue($objRS,"descrarea") ?></b></font><br>
					</td>
				</tr>
				<tr>
