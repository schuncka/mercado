...
<% VerificaDireito "|VIEW|", BuscaDireitosFromDB("mini_ListaFormaPgto",Session("METRO_USER_ID_USER")), true %>
<%
 ...
 Const TIT = "Lista Forma PGTO"									' - Nome/Titulo sendo referencia como titulo do módulo no botão de filtro
...
' ---------------------------------------------------------------------------------------------------------------
 ...
 strFields = "EFP.IDAUTO,EFP.COD_FORMAPGTO,EFP.COD_EVENTO,FP.FORMAPGTO,EFP.EXIBIR_LOJA,EFP.COD_PAIS,EFP.TIPO" 
 arrFields = Split(strFields,",")        

 arrLabels = Array("COD"              ,"COD F.PGTO"   ,"CODEVENTO"         ,"FORM PGTO"        ,  "EXIBIR LOJA" 	,  "COD PAIS" 	,  "TIPO" )
 arrSort   = Array("sortable-numeric" ,"sortable-numeric" ,"sortable-numeric"  ,"sortable-numeric" , "sortable-numeric" ,"sortable"  , "sortable" ) 'Obs.:"sortable-date-dmy", "sortable-currency", "sortable-numeric", "sortable" 
 arrWidth  = Array("2%"               ,"17%"              ,"12%"               ,     "15%"  	   ,   "15%"            ,    "15%"   ,"12%"  	)     'Obs.:[somar 98%] ou deixar todos vazios
' ----------------------------------------------------------------------------------------------------------------------------
