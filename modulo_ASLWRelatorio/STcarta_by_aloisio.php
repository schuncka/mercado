...
//BUSCA OS DADOS DO EMPRESA
		 $strSQLempresa = "select * from cad_empresa where  idempresa ilike '".$id_empresa."'";	
		try{				
...
<table width="100%"  border="0" class="bordasimples1">
  <tr>
    <td><table width="100%" border="0" class="bordasimples1">
        ...
        <tr>
          <td align="center" bgcolor="#000000"> <font color="#FFFFFF" size="2"><b><?php echo getValue($objRSevento,"dia_inicio")." a ".getValue($objRSevento,"dia_fim")." | ".nomeMes('10')." | " .getValue($objRSevento,"ano_fim")  ?></b></font></td>
          <td align="center">&nbsp;</td>
...
<div align="justify"><b>I. CONTRATANTES</b>
  ...
  <?php echo strtoupper(getValue($objRSempresa, "erazao")); ?>, inscrita no CNPJ nº <?php echo getValue($objRSempresa, "ecnpj"); ?> com sede na <?php echo getValue($objRSempresa, "erodape"); ?><br>
<b>2. EXPOSITOR</b>
</div>
<table width="100%" border="1" class="bordasimples1">
  <tr>
    <td width="14%">Código</td>
    <td width="41%" align="left"><div align="left"><?php echo getValue($objRSexpositor, "idempresa").getValue($objRSexpositor, "codigo");?></div></td>
    <td width="16%">Telefone</td>
    <td width="29%"><div align="left"><?php echo getValue($objRSexpositor, "telefone1"); ?></div></td>
  </tr>
  <tr>
    <td>Razão Social</td>
    <td><div align="left"><?php echo getValue($objRSexpositor, "razao"); ?></div></td>
    <td>Telefax</td>
    <td><div align="left"><?php echo getValue($objRSexpositor, "telefone2"); ?></div></td>
  </tr>
  <tr>
    <td>Nome Fantasia</td>
    <td><div align="left"><?php echo getValue($objRSexpositor, "fantasia"); ?></div></td>
    <td>Direção</td>
    <td><div align="left"><?php echo getValue($objRSexpositor, "telefone3"); ?></div></td>
  </tr>
  <tr>
    <td>Endereço</td>
    <td><div align="left"><?php echo getValue($objRSexpositor, "endereco"); ?></div></td>
    <td>CNPJ</td>
    <td><div align="left"><?php echo getValue($objRSexpositor, "cgcmf"); ?></div></td>
  </tr>
  <tr>
    <td>Bairro</td>
    <td><div align="left"><?php echo getValue($objRSexpositor, "bairro"); ?></div></td>
    <td>Inscr. Estadual</td>
    <td><div align="left"><?php echo getValue($objRSexpositor, "inscrest"); ?></div></td>
  </tr>
  <tr>
    <td>Cidade</td>
    <td><div align="left"><?php echo getValue($objRSexpositor, "cidade"); ?></div></td>
    <td>Inscr. Municipal</td>
    <td><div align="left"><?php echo getValue($objRSexpositor, "inscrmunicip"); ?></div></td>
  </tr>
  <tr>
    <td>Código Postal</td>
    <td><div align="left"><?php echo getValue($objRSexpositor, "cep"); ?></div></td>
    <td>E-Mail</td>
    <td><div align="left"><?php echo getValue($objRSexpositor, "email"); ?></div></td>
  </tr>
  <tr>
    <td>País</td>
    <td><div align="left"><?php echo getValue($objRSexpositor, "pais"); ?></div></td>
    <td>Website</td>
    <td><div align="left"><?php echo getValue($objRSexpositor, "website"); ?></div></td>
  </tr>
  <tr>
    <td>Nome no MAPA</td>
    <td><div align="left"><?php echo getValue($objRSexpositor, "nomemapa"); ?></div></td>
    <td>CT</td>
    <td><div align="left"><?php echo getValue($objRSexpositor, "idrepre"); ?></div></td>
  </tr>
  <tr>
    <td>Marcas</td>
...
<table width="100%" border="0" class="bordasimples1">
  <tr>
    ...
    <td width="98%" align="justify"><div align="justify"><b>OBJETO DO CONTRATO:</b>A <?php echo getValue($objRSevento, "erazao"); ?>, é a promotora exclusiva e única responsável pela Organização, Planejamento, Promoção e Administração da Feira <?php echo getValue($objRSevento, "nome_completo"); ?> - <?php echo getValue($objRSevento, "edicao"); ?>ª 	<?php      if ($id_empresa == "CM"){echo "Feira Internacional de Calçados, Artigos Esportivos e Artefatos de Couro";} 
				  else if ($id_empresa == "HP"){echo "Feira Internacional de Produtos, Equipamentos, Serviços e Tecnologia para Hospitais, Laboratórios, Farmácias, Clínicas e Consultórios";}
  ...
  <tr>
    ...
    <?php echo getValue($objRSevento, "tipoevento"); ?>, ao preço de: . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  . . . . . . . .<b>
...
<table width="80%" border="0"  class="bordasimples" align="left">
  ...
  // BUSCA AS PARCELAS
   ...
   $strSQLparcela = "SELECT   DISTINCT cad_evento.dt_fim    		,
							 ...
							 cad_renovacao_desconto.datavencimento	,         
  ...
  <tr>
    ...
    <td width="17%" align="center"><?php echo getValue($objRSparcela,""); ?></td>
    <td width="20%" align="center"><?php echo number_format(getValue($objRSparcela,"desconto")*100, 2, ',', '.'); ?> %</td>
    <td width="14%" align="center">R$ <?php echo number_format( getValue($objRSrenovacao, "area".$op_contrato) - ( getValue($objRSparcela,"desconto") * getValue($objRSrenovacao, "area".$op_contrato) ), 2, ',', '.'); ?></td>
...
<?php
	//BUSCA OS DADOS DADOS DE RENOVAÇÃO DO EVENTO
	  ...
	  $valor_total_bruto = $valor_total_bruto + getValue($objRSprodutos,"sub_total");
?>
   <tr>
    ...
    <td align="right"><?php echo number_format(getValue($objRSprodutos,"preco_end"), 2, ',', '.'); ?></td>
    <td align="right"><?php echo number_format(getValue($objRSprodutos,"sub_total"), 2, ',', '.'); ?></td>
  </tr>
<?php } ?>
</table>
...
<table width="100%" border="0" class="bordasimples1">
  ...
  <tr>
    <td valign="top"><b>2.</b></td>
    <td align="justify"><div align="justify">O EXPOSITOR autoriza expressamente a <?php echo getValue($objRSevento, "tipoevento"); ?> a emitir os boletos de cobrança bancária, originários do presente contrato, com vencimento
  ...
  <tr>
    ...
    Financeiro da <?php echo getValue($objRSevento, "tipoevento"); ?>. E, por estarem justas e contratadas, as partes assinam o presente contrato em duas vias de igual teor e forma. </div></td>
  </tr>
</table>
...
<table class="bordasimples1" width="100%" border="0">
  ...
  <tr>
    <td align="center"><?php echo getValue($objRSexpositor, "razao"); ?></td>
    <td>&nbsp;</td>
    <td align="center"><?php echo getValue($objRSempresa, "erazao"); ?></td>
  </tr>
</table>
