		...
		ElseIf FormMode = "Salvar" Then
			...
			If FormStatus = "" And InvalidFields = "" Then
				For Each fmRequest In Request.Form
				    ...
				    response.write "(" & fldTemp.Type & ")<BR>"
				    response.write mid(fmRequest, 6) & " = " & Request.Form(fmRequest) & "<BR>"
													...
													Else
														...
														Select Case Err.number
															...
															Case -2147217887
																...
																err.clear()
															Case Else
																FormStatus = FormStatus & " " & HTMLUpdateFieldFails & " " & mid(fmRequest, 6) & ": " & err.description & " (lin 1157)<BR>"& Err.number
																InvalidFields = InvalidFields & mid(fmRequest, 6) & ";"
																err.clear()
														End Select
													End If
