...
<%
 ...
 Dim  strCOD_EMPRESA ,Idx , strFIELD, strTYPE, strVALUE,strCODEVENTO
  
 strCOD_EMPRESA = GetParam("var_chavereg")
 
  
 If strCOD_EMPRESA <> "" Then
	  AbreDBConn objConn, CFG_DB 
	  
	  strSQL = "SELECT * FROM " & LTB & " WHERE COD_EMPRESA = " & strCOD_EMPRESA
