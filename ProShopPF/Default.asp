...
session.Abandon()
Response.Cookies("METRO_ProShopPF").Expires = DateAdd("d",-1,now())
 ...
 Response.Cookies("METRO_ProShopPF")("lng")	 								= strLng
 Response.cookies("METRO_ProshopPF")("METRO_ProShopPF_sessionId")				= session.SessionID

' response.write("cookie: "&request.Cookies("METRO_ProShopPF")("locale"))
...
'BUSCA DADOS DO EVENTO
	...
	strSQL = strSQL & " , e.proshop_cabecalho "
	strSQL = strSQL & " , e.proshop_rodape "
...
'response.write(strSQL)
 ...
 If NOT objRS.EOF Then
	...
	session("METRO_ProShopPF_strCabecalhoLoja")		= getValue(objRS,"proshop_cabecalho")
	session("METRO_ProShopPF_strRodapeLoja")			= getValue(objRS,"proshop_rodape")
...
response.cookies("METRO_ProshopPF")("METRO_ProShopPF_strNomeEvento")			= getValue(objRS,"nome")
response.cookies("METRO_ProshopPF")("METRO_ProShopPF_strNomeCompleto")		= getValue(objRS,"nome_completo")
response.cookies("METRO_ProshopPF")("METRO_ProShopPF_strCabecalhoLoja")		= getValue(objRS,"proshop_cabecalho")
response.cookies("METRO_ProshopPF")("METRO_ProShopPF_strRodapeLoja")			= getValue(objRS,"proshop_rodape")
response.cookies("METRO_ProshopPF")("METRO_ProShopPF_strLimiteIdade")			= getValue(objRS,"limite_idade")
response.cookies("METRO_ProshopPF")("METRO_ProShopPF_strByPassCortesia")		= getValue(objRS,"bypass_cortesia")
response.cookies("METRO_ProshopPF")("METRO_ProShopPF_IntegracaoToken")		= getValue(objRS,"proshop_token")
response.cookies("METRO_ProshopPF")("METRO_ProShopPF_IntegracaoCampanha")		= getValue(objRS,"proshop_campanha")
response.cookies("METRO_ProshopPF")("METRO_ProShopPF_strGoogleMapsEvento")   	= getValue(objRS,"proshop_google_maps")
response.cookies("METRO_ProshopPF")("METRO_ProShopPF_strEmailEvento")   		= getValue(objRS,"proshop_email_evento")
response.cookies("METRO_ProshopPF")("METRO_ProShopPF_strEmailContato1") 		= getValue(objRS,"proshop_email_contato1")
response.cookies("METRO_ProshopPF")("METRO_ProShopPF_strEmailContato2") 		= getValue(objRS,"proshop_email_contato2")
response.cookies("METRO_ProshopPF")("METRO_ProShopPF_strGtmId")		 		= ucase(getValue(objRS,"proshop_gtm_id"))
response.Cookies("METRO_ProshopPF")("COD_EVENTO")	 							= getValue(objRS,"cod_evento")
...
'OBS_TATI - para pegar o símboldo da moeda oficial do evento se adicionado LEFT JOIN
	...
	If strSimboloMoeda = "" Then 
		strSimboloMoeda = "$"   
	End If  
	response.cookies("METRO_ProshopPF")("METRO_ProShopPF_EventoFree") = strEventoFree
	If strLOCALE = "pt-br" Then
		...
		response.cookies("METRO_ProshopPF")("METRO_ProShopPF_Regulamento")  = getValue(objRS,"regulamento_loja")
		response.cookies("METRO_ProshopPF")("METRO_ProShopPF_CamposObrigatorios")	= getValue(objRS,"proshop_campos_obrigatorios")
        response.cookies("METRO_ProshopPF")("METRO_ProShopPF_CamposExibir") = getValue(objRS,"proshop_campos_exibir")
	End If
	If strLOCALE = "en-us" Then
		...
		response.cookies("METRO_ProshopPF")("METRO_ProShopPF_Regulamento")  = getValue(objRS,"regulamento_loja_intl")
		response.cookies("METRO_ProshopPF")("METRO_ProShopPF_CamposObrigatorios") = getValue(objRS,"proshop_campos_obrigatorios_en")
        response.cookies("METRO_ProshopPF")("METRO_ProShopPF_CamposExibir")	 = getValue(objRS,"proshop_campos_exibir_en")
	End If
	If strLOCALE = "es" Then
		...
		response.cookies("METRO_ProshopPF")("METRO_ProShopPF_Regulamento")  = getValue(objRS,"regulamento_loja_intl2")
		response.cookies("METRO_ProshopPF")("METRO_ProShopPF_CamposObrigatorios")	= getValue(objRS,"proshop_campos_obrigatorios_es")
        response.cookies("METRO_ProshopPF")("METRO_ProShopPF_CamposExibir")= getValue(objRS,"proshop_campos_exibir_es")
	End If	
 ...
 <div class="page container"> <!-- container-phone | container-tablet | container-large //-->
    ...
    <div class="page-header">
        ...
        <% If request.cookies("METRO_ProshopPF")("METRO_ProShopPF_strCabecalhoLoja") <>"" Then %>
            <div class="grid" style="margin-bottom:35px;background-color:#F8F8F8;">
                 <div class="row">
                     <div class="span14" ><!-- level 1 column //-->
                         <div class="row" >
        ...
        <div class="navigation-bar dark">
                <div class="navbar-content" id="eventBar">
                    ...
                    <a href="" onClick="javascript:submeter('default.asp');" class="element"><strong><%=request.cookies("METRO_ProshopPF")("METRO_ProShopPF_strNomeEvento")%></strong></a>
...
<!--                                        <font size="+1">R$ <%'=getValue(objRS,"prc_min")%> - R$ <%'=getValue(objRS,"prc_max")%></font>//-->
								  ...
								  <br>
									...
									<button class="button" style="padding: 10px; margin-bottom: 10px; width: 100%; border-radius: 5px; background-color: #090; color: #FFFFFF" onClick="javascript:submeter('Passo1_.asp');">
										<strong><%=(objLang.SearchIndex("botao_inscreva",0))%></strong>
									</button>
