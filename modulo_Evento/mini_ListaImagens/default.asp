...
<% VerificaDireito "|VIEW|", BuscaDireitosFromDB("mini_ListaImagens",Session("METRO_USER_ID_USER")), true %>
<%
 ...
 Const TIT = "Lista Imagens"									' - Nome/Titulo sendo referencia como titulo do módulo no botão de filtro
...
' ---------------------------------------------------------------------------------------------------------------
 ...
 strSQL = strSQL & "		   WHERE EI.COD_EVENTO = " & strCOD_EVENTO
 strSQL = strSQL & "		   ORDER BY EI.AREA, EI.ARQUIVO " 
 		  
 'athDebug strSQL , TRUE

 ' Define os campos para exibir na grade
 strFields = "EI.ID_AUTO, EI.COD_EVENTO, EI.ARQUIVO, EI.LARGURA, EI.ALTURA, EI.AREA" 
 arrFields = Split(strFields,",")        

 arrLabels = Array("COD"              ,"COD"              ,"ARQUIVO"          ,  "LARGURA" 	       ,  "ALTURA" 	,  "AREA" )
