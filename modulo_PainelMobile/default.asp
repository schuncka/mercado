...
<% VerificaDireito "|VIEW|", BuscaDireitosFromDB("modulo_PainelMobile", Request.Cookies("pVISTA")("ID_USUARIO")), true %>
<%
'Este modulo nao esta mais sendo utilizado pois criamos uma página que na raiz /cliente...com nome de primcipal_GenericPanel.asp![MODULO AGUARDANDO DELEÇÃO]
