...
?>
  ...
  <tr>	 
	<td align="center"  >
		<?php //$logo = '../img/logos/cab_ptb_'.$id_evento.'.jpg';
              /*Mudança do cabeçalho/rodapé ficarem dentro da pasta do cliente. By Lumertz  - 09.07.2013*/
              $logo	= '../../'.getsession(CFG_SYSTEM_NAME."_dir_cliente").'/upload/imgdin/cab_ptb_'.$id_evento.'.jpg';   		
		?>
  ...
  <tr>
  	<td colspan="2"><font size=2>Ref.: <b>  LOCALIZAÇÃO DO SEU ESTANDE NA <?php echo getValue($objRS,"nome_completo"); ?></b><br><br></font></td>  	 
  </tr>
  <tr>
  	<td colspan="2"><font size=2>Senhor Expositor,</font></td>  	 
  </tr>
  <tr>
  	<td colspan="2"><font size=2>Gostariamos de informá-lo que seu estande na <?php echo getValue($objRS,"nome_completo"); ?>  está localizado conforme dados abaixo:</font><BR><BR>
  	  <table align="center" bgcolor="#FFFFFF" width="90%" border="1">
	<tr>
	 <td style="border:none;"><font size=2>
	 LOCALIZAÇÂO: <b><?php echo getValue($objRS,"localiz") ?></b><BR>
	 TIPO DE ÁREA:</font><font size="2" color="#FF0000"> <b><?php echo getValue($objRS,"descrarea") ?></b>
	 </font><br></td>
	</tr>
	<br>
	<tr>
	 <td align="center" style="border:none;"><font size=2>
		 <b>METRAGEM DO ESTANDE</b><BR>
	...
	Para melhor visualização, segue anexa planta baixa do evento, com a demarcação do espaço de sua empresa.<BR><br>
	...
	<tr align="center">
		<td colspan="2">
        <?php  //$url = '../img/logos/rod_ptb_'.$id_evento.'.jpg';  
               /*Mudança do cabeçalho/rodapé ficarem dentro da pasta do cliente. By Lumertz  - 09.07.2013*/  
               $url	= '../../'.getsession(CFG_SYSTEM_NAME."_dir_cliente").'/upload/imgdin/rod_ptb_'.$id_evento.'.jpg';   		
		?>
