                    ...
                    <div class="button-dropdown place-left" style="width:20px; height:20px; border:0px solid #F00;">
                           <img class="dropdown-toggle" src="../img/icon_action.gif"  >                            
                             ...
                             <!--DELETE comentado pois neste modo procede que não haja exclusões de registros sem a devida supervisão//-->
                                <li><%=AthWindow ("update.asp?var_chavereg=" & GetValue(objRS,DKN), 520, 720, "ALTERAR")%></li>
                                <li><%=AthWindow ("detail.asp?var_chavereg=" & GetValue(objRS,DKN), 520, 720, "VISUALIZAR")%></li>
                                <li class="divider">
          ...
          <% 
            for j=0 to objRS.Fields.count-1 
              if inStr(strFields, objRS.Fields(j).name)>0 then
                ...
                'Tratamento especial exibição campo MOEDA_ORIGEM
                If (objRS.Fields(j).name = "MOEDA_ORIGEM") Then
                    IF (strINFO="REAL") Then
                        strINFO = Response.Write("<p class='text fg-red'>REAL</p>") 
					else
					    IF (strINFO="DOLAR") Then
                            strINFO = Response.Write("<p class='text fg-blue'>DOLAR</p>") 
					     else
						    strINFO = Response.Write("<p class='text fg-black'>EURO</p>")	
			...
			End if	
                ...
                'Tratamento especial exibição campo MOEDA_ORIGEM
                If (objRS.Fields(j).name = "MOEDA_DESTINO") Then
                    IF (strINFO="REAL") Then
                        strINFO = Response.Write("<p class='text fg-red'>REAL</p>") 
					else
					    IF (strINFO="DOLAR") Then
