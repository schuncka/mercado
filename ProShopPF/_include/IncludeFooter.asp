...
strFooter = strFooter & "                <div class='span10' >" & vbnewline
                  If  request.cookies("METRO_ProshopPF")("METRO_ProShopPF_strEmailEvento") <> ""  or request.cookies("METRO_ProshopPF")("METRO_ProShopPF_strEmailContato1") <> "" or  request.cookies("METRO_ProshopPF")("METRO_ProShopPF_strEmailContato2") <> "" Then 
...
strFooter = strFooter & "                            <div class='row'>" & vbnewline
                  If  request.cookies("METRO_ProshopPF")("METRO_ProShopPF_strEmailEvento") <> ""  or request.cookies("METRO_ProshopPF")("METRO_ProShopPF_strEmailContato1") <> "" Then 
strFooter = strFooter & "                                <div class='span4'>" & vbnewline
                                 If request.cookies("METRO_ProshopPF")("METRO_ProShopPF_strEmailEvento") <> "" Then
strFooter = strFooter & "    	                                <h4 class='fg-white'><strong>"&(objLang.SearchIndex("rodape_contato1",0))&"</strong></h4>" & vbnewline
strFooter = strFooter & "        	                            <p class='tertiary-text-secondary fg-white'>"&request.cookies("METRO_ProshopPF")("METRO_ProShopPF_strEmailEvento")&"</p>" & vbnewline
                                 End If
								 If request.cookies("METRO_ProshopPF")("METRO_ProShopPF_strEmailContato1") <> "" Then 
strFooter = strFooter & "	                                    <p class='tertiary-text-secondary fg-white'>"&request.cookies("METRO_ProshopPF")("METRO_ProShopPF_strEmailContato1")&"</p>" & vbnewline
                                 End If 
strFooter = strFooter & "                                </div>" & vbnewline
                  End If  
							   	 If request.cookies("METRO_ProshopPF")("METRO_ProShopPF_strEmailContato2") <> "" Then							    
...
strFooter = strFooter & "                                        <p class='tertiary-text-secondary fg-white'>"&request.cookies("METRO_ProshopPF")("METRO_ProShopPF_strEmailContato2")&"</p>" & vbnewline
strFooter = strFooter & "                                    </div>" & vbnewline
                                 End If 
if request.cookies("METRO_ProshopPF")("METRO_ProShopPF_EventoFree") <> 1 then
strFooter = strFooter & "                                <div class='span3'>" & vbnewline
