...
<% 'VerificaDireito "|INS|", BuscaDireitosFromDB("modulo_StatusCresModelo",Session("METRO_USER_ID_USER")), true %>
<%
 ...
 Dim  i,strCOD_STATUS_CRED_MODELO ',strCOD_EVENTO,strCOD_STATUS_CRED,strMODELO_NOME,strMODELO_LAYOUT
...
function ok() { 
 <% if (CFG_WINDOW = "NORMAL") then 
  		response.write ("document.forminsert.DEFAULT_LOCATION.value='../modulo_StatusCredModelo/default.asp';") 
	 else
...
function aplicar()      { 
  document.forminsert.DEFAULT_LOCATION.value="../modulo_StatusCredModelo/insert.asp"; 
  if (validateRequestedFields("forminsert")) { 
                    ...
                    <div class="row ">
                                    ...
                                    <div class="span8"><p class="input-control select" data-role="input-control"> 
                                         <select name="DBVAR_NUM_COD_STATUS_CRED" id="DBVAR_NUM_COD_STATUS_CRED" >
                                             <% montaCombo "STR" ,"SELECT COD_STATUS_CRED, CONCAT(CAST(COD_STATUS_CRED AS CHAR), ' - ', CAST(STATUS AS CHAR)) AS STATUS FROM tbl_status_cred ORDER BY COD_STATUS_CRED", "COD_STATUS_CRED", "STATUS", null %>
                                            </select></p>
                                         <!--span class="tertiary-text-secondary">(variáveis de ambiente (session) podem ser utilizadas através de  chaves - { }).</span//-->  
                                    </div> 
                    </div>
                     <div class="row ">
                                ...
                                <div class="span8"> 
                                     <p class="input-control text " data-role="input-control"><input id="DBVAR_STR_MODELO_NOME" name="DBVAR_STR_MODELO_NOME" type="text" placeholder="" value="" maxlength="80"></p>
                      ...
                      <div class="row ">
                                ...
                                <div class="span8"> 
                                     <p class="input-control textarea" ><textarea id="DBVAR_STR_MODELO_LAYOUT" name="DBVAR_STR_MODELO_LAYOUT" type="text" ></textarea></p>
                                     <span class="tertiary-text-secondary"></span>                             
                                </div>
                     </div>                    
                    </div> <!--FIM GRID//-->
