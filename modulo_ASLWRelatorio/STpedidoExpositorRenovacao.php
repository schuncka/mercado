				...
				<tr>
				  <td align="center" valign="top" style="padding:10px 10px 10px 10px;"><table cellspacing="2" cellpadding="3" border="0" width="100%">
					...
					<tr>
                      ...
                      <td align="left"><?php echo(getvalue($objRS,"localpe"));?></td>
                    </tr>
...
try{
	...
	$strSQL = "SELECT
					  ped_pedidos_renovacao_evento.cod_pedidos_renovacao_evento
					, ped_pedidos_renovacao_evento.descrpedido
					, ped_pedidos_renovacao_evento.preco_pedi
					, ped_pedidos_renovacao_evento.quant_pedi
			    	, ped_pedidos_renovacao_evento.sub_total
					, ped_pedidos_renovacao_evento.unidpedido
					, ped_pedidos_renovacao_evento.sys_usr_ins
					, ped_pedidos_renovacao_evento.desc_pedi
					, ped_pedidos_renovacao_evento.idproduto
...
?>				
							...
							<tr>
								<td width="3%" align="center"><strong><?php echo(getTText("it",C_NONE));?></strong></td>
								<td width="9%" align="left"><strong><?php echo(getTText("idproduto",C_NONE));?></strong></td>
								<td width="27%" align="left"><strong><?php echo(getTText("desc_pedi",C_NONE));?></strong></td>
								<td width="8%" align="center"><strong><?php echo(getTText("unidpedido",C_NONE));?></strong></td>
								<td width="10%" align="right"><strong><?php echo(getTText("preco_pedi",C_NONE));?></strong></td>
								<td width="7%" align="right"><strong><?php echo(getTText("quant_pedi",C_NONE));?></strong></td>
								<td width="6%" align="right"><strong><?php echo(getTText("desconto",C_NONE));?></strong></td>
								<td width="11%" align="right"><strong><?php echo(getTText("preco_final",C_NONE));?></strong></td>
								<td width="19%" align="right"><strong><?php echo(getTText("sub_total",C_NONE));?></strong></td>
		...
		<td align="right">
			...
			<table>
				...
				<tr>
					...
					<td align="right">
						<?php 
							if ($totalOS > 5000 and $calc_css != ''){$retencao_css = $totalOS * 0.0465;}
				...
				<tr>
					...
					echo number_format(($totalOS  - ($retencao_ir + $retencao_css + $retencao_iss)), 2, ',', '.');
