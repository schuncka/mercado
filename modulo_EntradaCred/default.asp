...
<% VerificaDireito "|VIEW|", BuscaDireitosFromDB("modulo_EntradaCred",Session("METRO_USER_ID_USER")), true %>
<%
 ...
 Const TIT = "Entrada Credencial"    							' - Nome/Titulo sendo referencia como titulo do módulo no botão de filtro
