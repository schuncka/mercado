...
<%
 ...
 Const DLD = "../modulo_Usuario/mini_ListaEvento/default.asp" 	' "../evento/data.asp" - 'Default Location após Deleção
...
'---------------------------------------------------------------------------------------------------------------
 ...
 'Altera a qtde de elemetnos por página a partir do filtro------------------------------------------------------ 
...
'----------------------------------------------------------------------------------------------
 ...
 arrLabels = Array("Cod"                ,"COD_EVENTO"         ,"Descrição"                ,"Cod User"         )
