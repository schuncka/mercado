...
strSQL = " SELECT t1.cod_marca ,t1.cod_cliente, descr_marca  from tbl_clientes_marcas t1 " 
strSQL = strSQL & " WHERE t1.cod_cliente  = " & strCodCli 
strSQL = strSQL & " ORDER BY 1 " 
 ...
 strFields = "cod_marca , descr_marca " 
 arrFields = Split(strFields,",")        

 arrLabels = Array("COD"              , "MARCA"      )
 arrSort   = Array("sortable-numeric" , "sortable"   )     'Obs.:"sortable-date-dmy", "sortable-currency", "sortable-numeric", "sortable" 
 arrWidth  = Array("2%"               , "96%"        )     'Obs.:[somar 98%] ou deixar todos vazios
' ----------------------------------------------------------------------------------------------------------------------------
