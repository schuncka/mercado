                                    ...
                                    <div class="span8">
                                        <div class="input-control select size2" data-role="input-control">
                                            ...
                                            <select name="DBVAR_STR_idcategoria" id="DBVAR_STR_idcategoria" class="">
                                                <% montaCombo "STR" ,"SELECT idprod, produto from tbl_produtos order by 1", "idprod", "produto", " "%>
                                            </select>
                                            </p>
                                        </div> 
                                    </div>
                            ...
                            <div class="span2"><p>Ficha BBM:</p></div> 
                                    <div class="span8">
                                        <div class="input-control radio margin10" data-role="input-control">
                                            <label>
                                                Sim
                                                <input type="radio" name="fichabbm" value="1"  />
                                                <span class="check"></span>
                                            </label>
                                        </div>
                                        <div class="input-control radio margin10" data-role="input-control">
                                            <label>Não                                              
                                                <input type="radio" name="fichabbm" value="0" checked />
                                                <span class="check"></span>
                                            </label>
                                        </div>
                                    </div> 
