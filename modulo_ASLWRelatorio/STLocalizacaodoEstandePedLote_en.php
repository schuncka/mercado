...
?>
  ...
  <tr>	 
	<td  align="center"  >
		<?php //$logo = '../img/logos/cab_en_'.$id_evento.'.jpg';
		      /*Mudança do cabeçalho/rodapé ficarem dentro da pasta do cliente. By Lumertz  - 09.07.2013*/
              $logo	= '../../'.getsession(CFG_SYSTEM_NAME."_dir_cliente").'/upload/imgdin/cab_en_'.$id_evento.'.jpg';   
		?>
  ...
  <tr align="center">
    <td colspan="2" align="center"> <font size=3> <?php echo getValue($objRS,"dt_inicio"); ?>  to <?php echo getValue($objRS,"dt_fim"); ?>   </font></td>
  </tr>
  ...
  <tr>
  	<td colspan="2"><font size=2>Ref.: <b>  LOCATION OF YOUR BOOTH IN <?php echo getValue($objRS,"nome_completo"); ?></b><br><br></font></td>  	 
  </tr>
  <tr>
  	<td colspan="2"><font size=2>Mr Speaker,</font></td>  	 
  </tr>
  <tr>
  	<td colspan="2"><font size=2>We would like to inform you that your booth at <?php echo getValue($objRS,"nome_completo"); ?>  is located as given below:</font><BR><BR>
  	  <table align="center" bgcolor="#FFFFFF" width="90%" border="1">
	<tr>
	 <td style="border:none;"><font size=2>
	 LOCATION: <b><?php echo getValue($objRS,"localiz") ?></b><BR>
	 TYPE OF AREA:</font><font size="2" color="#FF0000"> <b><?php echo getValue($objRS,"descrarea") ?></b>
	 </font><br></td>
	</tr>
	<br>
	<tr>
	 <td align="center" style="border:none;"><font size=2>
		 <b>FILM BOOTH</b><BR>
		 <b> <?php echo number_format(getValue($objRS,"w"),2, '.', '') ; ?>  meters in X 
		     <?php echo number_format(getValue($objRS,"comprimento"),2, '.', '') ; ?> meters deep = 
	...
	For best viewing, following attached floor plan of the event, with the demarcation of the area of your business.<BR><br>
	We place ourselves at your disposal for any additional clarification.<BR><br>
	Regards,</font><BR>
	<BR>
	...
	<tr align="center">
		<td colspan="2">
        <?php  //$url = '../img/logos/rod_en_'.$id_evento.'.jpg';  
		       /*Mudança do cabeçalho/rodapé ficarem dentro da pasta do cliente. By Lumertz  - 09.07.2013*/
               $url	= '../../'.getsession(CFG_SYSTEM_NAME."_dir_cliente").'/upload/imgdin/rod_en_'.$id_evento.'.jpg';   				
		?>
