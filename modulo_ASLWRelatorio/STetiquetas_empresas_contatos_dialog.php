   ...
   <td align="center" valign="top">
	 <div id="DialogGlass" class="bordaBox" style="width:600; height:none;">
		...
		<table border="0" width="100%" bgcolor="#FFFFFF" style="border:1px #A6A6A6 solid;">
		  <form name="formconf" id="formconf" action="STetiquetas_empresas_contatos.php" method="post">
			<tr><td style="padding:10px;"><b>Campos Da Consulta</b></td></tr>
			<tr>
				<td align="center" valign="top">
					<table width="350px" border="0" cellspacing="0" cellpadding="4">
					
						<tr>
							<td width="100" align="right">ID Empresa: </td>
							<td width="434"><input type="text" name="var_empresa" id="var_empresa" value="" maxlength="2" size="4" ></td>
						</tr>
						<tr>  
							<td align="right" >Estado: </td>
							<td><input type="text" name="var_estado" id="var_estado" value="" maxlength="2" size="4" ></td>
						</tr>
						<tr>
							<td height="5" colspan="3"></td>
						</tr>
						<tr>
							<td height="1" colspan="3" bgcolor="#DBDBDB"></td></tr>
						<tr>
