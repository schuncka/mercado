             ...
             <% 'If GetValue(objRS,"SYS_DATACA") = "" Then %>
                    <div class="button-dropdown place-left" style="width:20px; height:20px; border:0px solid #F00;">
                           <img class="dropdown-toggle" src="../../img/icon_action.gif"  >                            
                             ...
                             <%
 							 If strEV_MUNICIPIO = "CURITIBA" Then							 
							 %>                                
	                             <li><%=AthWindowNew ("https://isscuritiba.curitiba.pr.gov.br/portalNfse/Default.aspx?doc="&strEV_CNPJ&"&amp;num="&objRS("NFE")&"&amp;cod="&objRS("NFE_CODIGO"), 520, 620,ucase(objLang.SearchIndex("mini_imprimir",0)))%></li>
                             <% Else %>
	                             <li><%=AthWindowNew ("https://nfe.prefeitura.sp.gov.br/contribuinte/notaprint.aspx?nf="&objRS("NFE")&"&amp;inscricao="&strEV_INSCR_MUNICIPAL&"&amp;verificacao="&objRS("NFE_CODIGO"), 520, 620,ucase(objLang.SearchIndex("mini_imprimir",0)))%></li>
                             <% End If %>    							 
                            </ul>
                    </div>                        
             <% 'End if %>
       ...
       <td colspan="<%=UBound(arrFields)+3%>" style="padding-top:3px; border-top:1px solid #000;  background-color:#F8F8F8;" >
            <div style="width:100%; height:35px;">
                 ...
                 <div style="width:150px; height:28px; float:right; text-align:center; border:1px solid #00ADEF; border-radius: 25px; background-color:#00ADEF; margin-right:5px; margin-top:5px; padding-top:0px;" >
                  <form name="formPaginar" id="formPaginar" action="default.asp<%="?var_cod_inscricao="&strCOD_INSCRICAO%>" method="post">
