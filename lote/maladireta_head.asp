...
<table width="640" border="0" cellspacing="0" cellpadding="0">
  <form name="formulario" method="post" action="maladireta_body.asp" target="frm_maladetail">
  <input name="var_chavereg" type="hidden" value="<%=strCOD_LOTE%>">
  <tr> 
    <td height="17" colspan="3" align="center" class="arial12Bold">Lotes - Etiquetas</td>
  </tr>
  <tr> 
  ...
  <tr> 
    <td height="19" colspan="3" align="right" class="arial12Bold"><a href="javascript:ImprimeMala();" class="Tahomacinza9"><img src="../img/ico_impressora_mini.gif" border="0">imprimir</a></td>
  </tr>
  </form>
</table>
</body>
