                    ...
                    <div class="button-dropdown place-left" style="width:20px; height:20px; border:0px solid #F00;">
                           <img class="dropdown-toggle" src="../img/icon_action.gif"  >                            
                             ...
                             <!--DELETE comentado pois neste modo procede que não haja exclusões de registros sem a devida supervisão//-->
                                ...
                                <li class="divider">
                                  <%
								   if  VerificaDireito ("|DEL|", BuscaDireitosFromDB("modulo_FormularioSetup",Session("METRO_USER_ID_USER")), false) = true then
								  %>
          ...
          <% 
            for j=0 to objRS.Fields.count-1 
              if inStr(strFields, objRS.Fields(j).name)>0 then
				...
				strINFO = Server.HTMLEncode(GetValue(objRS,objRS.Fields(j).name))
                if (objRS.Fields(j).name = "VINCULADO_ENTIDADE") Then
                    if (strINFO <> "1") Then
                ...
                End If
				 ...
				 if (objRS.Fields(j).name = "REQUERIDO") Then
                    if (strINFO = "1") Then
                        ...
                        strINFO = Response.Write("<i class='icon-cancel-2'></i>")	
						  ...
						  strINFO = Response.Write("<i class='icon-cancel'></i>")
						 end if 
                    End If
                End If
