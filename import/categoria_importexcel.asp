...
Select Case strACAO
  ...
  Case "PREPARAR"
		...
		%>
		<form name="FormImport2" id="FormImport2" action="categoria_importexcel.asp" method="post">
...
%>
  ...
  Case "UPLOAD"
	...
	<form name="FormImport" id="FormImport" action="categoria_importexcel.asp" method="post">
...
<div class="arial12">
  ...
  <p><strong>Passo 1</strong> &ndash;          Verifique se a Planilha Excel a ser importada segue o modelo          espec&iacute;fico para importa&ccedil;&atilde;o (<a href="MODELO_IMPORTACAO_<%=ucase(CFG_IDCLIENTE)%>.xls" class="arial12Bold"><u>clique aqui para baixar o modelo</u></a>).</p>
...
<br />
<div align="center">
<a onClick="javascript:importar();" href="#"><img src="../img/ico_excel.gif" alt="Importar Situação Cadastral <%=ucase(CFG_IDCLIENTE)%> do Excel"  border="0"></a><br>
<br>
<form name="formimport" action="categoria_importexcel.asp" method="post">


             <input type="hidden" name="var_acao" value="UPLOAD">
            <select name="var_cod_evento" class="textbox380" onChange="document.location='categoria_importexcel.asp?cod_evento='+this.value;">
            <%
            ...
            <input type="hidden" name="var_nomes" value="<%=Server.HTMLEncode("Codigo Evento,CPF/CNPJ,Nome,Descrição,Categoria,E-mail")%>">
