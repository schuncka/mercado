...
<% Option Explicit %>
<%
 Dim strNOME, strCATEGORIA, strDESCRICAO, strTEXTO, strSQL
...
<body bgcolor="#F7F7F7" leftmargin="0" rightmargin="0" topmargin="0" bottommargin="0" onResize="adjustWindow();" onLoad="adjustWindow();">
<div id="tudo">
  <div id="topo">
  ...
  <div id="conteudo">
    <iframe frameborder="1" name="frm_resulaslw_detail" id="frm_resulaslw_detail" src="ResultASLW_Detail.asp?var_strParam=<%=strSQL%>&var_descricao=<%=strDESCRICAO%>" width="99%" height="100%"></iframe>
    </div>
    <div id="rodape">
    <table width="99%" height="30" cellpadding="0" cellspacing="0" border="0" bgcolor="#F7F7F7">
     <tr>
       ...
       <td width="190" align="right" valign="middle">
        <form name="formacao" action="ResultASLW_Detail.asp" method="post" target="_blank">
