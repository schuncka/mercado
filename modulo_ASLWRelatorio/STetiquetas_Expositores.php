...
$strSQL = " SELECT DISTINCT 
                ...
                CASE WHEN (cad_montador.nomemont is null)
                	THEN ''
                	ELSE 'Montadora.:'||SUBSTR (cad_montador.nomemont, 1, 38)
                END AS nome_montador	

FROM            (PED_PEDIDOS
                LEFT JOIN CAD_MONTADOR
...
<table width="45%" border="0" align="left">  
  ...
  <tr>
	...
	<tr>
    <td width="45%"><?php echo getValue($objRS,"nome_montador"); ?></td>
  </tr>
</table>
...
<table width="55%" border="0" >  
  ...
  <tr>
	...
	<tr>    <td width="16%">&nbsp;</td>
      <td width="84%"><?php echo getValue($objRS,"nome_montador"); ?></td>
  </tr>
</table>
