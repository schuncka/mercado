                    ...
                    <div class="button-dropdown place-left" style="width:20px; height:20px; border:0px solid #F00;">
                           <img class="dropdown-toggle" src="../img/icon_action.gif"  >                            
                             ...
                             <!--DELETE comentado pois neste modo procede que não haja exclusões de registros sem a devida supervisão//-->
                                ...
                                <li>
                                	<a class="dropdown-toggle" href="#">EXEC LOTE</a>
                                		<ul class="dropdown-menu" data-role="dropdown">
											<%
                                            'response.Write("<li><a href=""javascript:AbreJanelaPAGE('news.asp?var_chavereg=" & objRS("COD_LOTE") & "','660', '460')"" class=""arial10"">NEWS</a></li>")
                                            response.Write("<li><a href=""javascript:AbreJanelaPAGE('exportaexcel.asp?var_chavereg=" & objRS("COD_LOTE") & "','660', '460')"" class=""arial10"">EXP_EXCEL</a></li>")
                                            response.Write("<li><a href=""javascript:AbreJanelaPAGE('maladireta.asp?var_chavereg="& objRS("COD_LOTE") & "','660', '600')"" class=""arial10"">MALA_DIREITA</a></li>")
                                            response.Write("<li><a href=""javascript:AbreJanelaPAGE('credencial.asp?var_chavereg=" & objRS("COD_LOTE") & "','700', '600')"" class=""arial10"">CREDENCIAL</a></li>")
                                            response.Write("<li><a href=""javascript:AbreJanelaPAGE('chaveacesso.asp?var_chavereg=" & objRS("COD_LOTE") & "','660', '600')"" class=""arial10"">CHAVE_ACESSO</a></li>")
                                            response.Write("<li><a href=""javascript:AbreJanelaPAGE('fichaatualizacao.asp?var_chavereg=" & objRS("COD_LOTE") & "','660', '600')"" class=""arial10"">FICHA_ATUALIZA</a></li>")
                                            %>
	                                    </ul>
                                </li>
                                <li><%=AthWindow ("update.asp?var_chavereg=" & GetValue(objRS,DKN), 600, 480, "ALTERAR")%></li>
                                <li class="divider">
                                <li><%=AthWindow ("detail.asp?var_chavereg=" & GetValue(objRS,DKN), 600, 480, "VISUALIZAR")%></li>
